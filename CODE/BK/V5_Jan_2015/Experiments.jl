...
function make_local()
	...
	for YR = 1:YEARS # years
		for day = 1:365/DT# days
			...
			W.I[1] = (det[DY] .* 60 .* 60 .* 24) * 0.5 ## account for change in detrital pool here
            ...
            PISC,PLAN,DETR = sub_mrt(PISC,PLAN,DETR,PRM_PI,PRM_PL,PRM_DE)

            ###! MASS BALANCE
            PISC,PLAN,DETR,W = sub_update_bio(PISC,PLAN,DETR,W,PRM_PI,PRM_PL,PRM_DE,DT)
