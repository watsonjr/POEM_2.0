...
save([dpath 'Biomes_fore_fished',harv,'_' cfile '.mat'],'biome_mbio50');
...
stamp(cfile)
print('-dpng',[ppath 'Fore_fished',harv,'_biomes_All.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Fore_fished',harv,'_biomes_AllF.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Fore_fished',harv,'_biomes_AllP.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Fore_fished',harv,'_biomes_AllD.png'])
...
title('log10 mean biomass All Fishes (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_fished',harv,'_Pac_biomes_All.png'])
...
title('log10 mean biomass Forage Fishes (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_fished',harv,'_Pac_biomes_AllF.png'])
...
title('log10 mean biomass Pelagic Fishes (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_fished',harv,'_Pac_biomes_AllP.png'])
...
title('log10 mean biomass Demersal Fishes (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_fished',harv,'_Pac_biomes_AllD.png'])
