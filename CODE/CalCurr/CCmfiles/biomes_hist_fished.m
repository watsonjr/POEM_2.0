...
save([dpath 'Biomes_hist_fished',harv,'_' cfile '.mat'],'biome_mbio50');
...
stamp(cfile)
print('-dpng',[ppath 'Hist_fished',harv,'_biomes_All.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Hist_fished',harv,'_biomes_AllF.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Hist_fished',harv,'_biomes_AllP.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Hist_fished',harv,'_biomes_AllD.png'])
