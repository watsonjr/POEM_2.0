...
tot_area3_km2 = nansum(GRD3.AREA) * 1e-6;
...
Amf_catch3  = mf_my3  .* GRD3.AREA  * 365; %mean fish catch per yr
Amp_catch3  = mp_my3  .* GRD3.AREA  * 365;
Amd_catch3  = md_my3  .* GRD3.AREA  * 365;
Alp_catch3  = lp_my3  .* GRD3.AREA  * 365;
Ald_catch3  = ld_my3  .* GRD3.AREA  * 365;
...
AF_catch3 = Amf_catch3;
AP_catch3 = Amp_catch3 + Alp_catch3;
AD_catch3 = Amd_catch3 + Ald_catch3;
All_catch3 = AF_catch3 + AP_catch3 + AD_catch3;
...
AF_mcatch3 = nansum(AF_catch3) * 1e-6;
AP_mcatch3 = nansum(AP_catch3) * 1e-6;
AD_mcatch3 = nansum(AD_catch3) * 1e-6;
All_mcatch3 = nansum(All_catch3) * 1e-6;
...
AF_mcatch3_km2 = AF_mcatch3 ./ tot_area3_km2;
AP_mcatch3_km2 = AP_mcatch3 ./ tot_area3_km2;
AD_mcatch3_km2 = AD_mcatch3 ./ tot_area3_km2;
All_mcatch3_km2 = All_mcatch3 ./ tot_area3_km2;

FracPD10 = AP_mcatch10_km2 ./ (AP_mcatch10_km2 + AD_mcatch10_km2);
FracPD3 = AP_mcatch3_km2 ./ (AP_mcatch3_km2 + AD_mcatch3_km2);
...
l10p_3=log10(All_mcatch3_km2);
l10pF_3=log10(AF_mcatch3_km2);
l10pP_3=log10(AP_mcatch3_km2);
l10pD_3=log10(AD_mcatch3_km2);
...
plot(l10sF,l10pF_10,'.k','MarkerSize',15); hold on;
plot(l10cF,l10pF_10,'.b','MarkerSize',15); hold on;
plot(l10sF,l10pF_3,'.r','MarkerSize',15); hold on;
plot(l10cF,l10pF_3,'.m','MarkerSize',15); hold on;
axis([-2 0 -2 0])
xlabel('SAU')
ylabel('FEISTY ')
title('Forage Fishes')
...
plot(x,x5h,':','color',[0.5 0.5 0.5]); hold on;
plot(x,x5l,':','color',[0.5 0.5 0.5]); hold on;
plot(l10sP,l10pP_10,'.k','MarkerSize',15); hold on;
plot(l10cP,l10pP_10,'.b','MarkerSize',15); hold on;
plot(l10sP,l10pP_3,'.r','MarkerSize',15); hold on;
plot(l10cP,l10pP_3,'.m','MarkerSize',15); hold on;
axis([-1 1 -1 1])
xlabel('SAU')
ylabel('FEISTY ')
...
plot(x,x5h,':','color',[0.5 0.5 0.5]); hold on;
plot(x,x5l,':','color',[0.5 0.5 0.5]); hold on;
plot(l10sD,l10pD_10,'.k','MarkerSize',15); hold on;
plot(l10cD,l10pD_10,'.b','MarkerSize',15); hold on;
plot(l10sD,l10pD_3,'.r','MarkerSize',15); hold on;
plot(l10cD,l10pD_3,'.m','MarkerSize',15); hold on;
axis([-1 0 -1 0])
xlabel('SAU')
ylabel('FEISTY ')
title('Demersals')
...
plot(x,x5h,':','color',[0.5 0.5 0.5]); hold on;
plot(x,x5l,':','color',[0.5 0.5 0.5]); hold on;
plot(l10s,l10p_10,'.k','MarkerSize',15); hold on;
plot(l10c,l10p_10,'.b','MarkerSize',15); hold on;
plot(l10s,l10p_3,'.r','MarkerSize',15); hold on;
plot(l10c,l10p_3,'.m','MarkerSize',15); hold on;
axis([-1 1 -1 1])
xlabel('SAU')
ylabel('FEISTY ')
title('All fishes')
