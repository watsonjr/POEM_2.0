...
%harv = 'pristine';
harv = 'All_fish03';
%harv = 'fish_F013_P025_D008';

fpath=['/Volumes/GFDL/NC/Matlab_new_size/' cfile '/CalCurr/'];

%% Benthic material
ncid = netcdf.open([fpath 'Spinup10km_' harv '_bent.nc'],'NC_NOWRITE');
...
%% SP
ncid = netcdf.open([fpath 'Spinup10km_' harv '_sml_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% SF
ncid = netcdf.open([fpath 'Spinup10km_' harv '_sml_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% SD
ncid = netcdf.open([fpath 'Spinup10km_' harv '_sml_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MP
ncid = netcdf.open([fpath 'Spinup10km_' harv '_med_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MF
ncid = netcdf.open([fpath 'Spinup10km_' harv '_med_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MD
ncid = netcdf.open([fpath 'Spinup10km_' harv '_med_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LP
ncid = netcdf.open([fpath 'Spinup10km_' harv '_lrg_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LD
ncid = netcdf.open([fpath 'Spinup10km_' harv '_lrg_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%
save([fpath 'Means_Spinup10km_' harv '_' cfile '.mat'],...
...
save([fpath 'Last_mo_Spinup10km_' harv '_' cfile '.mat'],'Sml_f','Sml_p','Sml_d',... 
