...
%% save
Tab=array2table(bios,'RowNames',sites(red),...
    'VariableNames',{'NPP','Z','Bent','F','P','D'});
writetable(Tab,[dpath sname harv '_red_locs_biomasses.csv'],'Delimiter',',');

Flu=array2table(flux,'RowNames',sites(red),...
    'VariableNames',{'fdet','zhploss','FconZ','PconF','DconF','DconP','DconB'});
writetable(Flu,[dpath sname harv '_red_locs_fluxes.csv'],'Delimiter',',');

rsites = sites(red);
save([dpath sname harv '_red_locs_biom_flux.mat'],'Tab','Flu','rsites',...
    'bios','flux');
