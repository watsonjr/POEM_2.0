...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SP_prod.png'])
%
% % sf
% figure(12)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SF_prod.png'])
%
% % sd
% figure(13)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SD_prod.png'])
%
% % mp
% figure(14)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MP_prod.png'])
%
% % mf
% figure(15)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MF_prod.png'])
%
% % md
% figure(16)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MD_prod.png'])
%
% % lp
% figure(17)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_LP_prod.png'])
%
% % ld
% figure(18)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_LD_prod.png'])
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_All_prod.png'])
% 
% % all F
% figure(22)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllF_prod.png'])
% 
% % all D
% figure(23)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllD_prod.png'])
% 
% % All P
% figure(24)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllP_prod.png'])
...
stamp([harv '_' cfile])
print('-dpng',[ppath 'Climatol_' harv '_global_All_subplot_prod.png'])
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllS_prod.png'])
% 
% % all M
% figure(3)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllM_prod.png'])
% 
% % All L
% figure(4)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllL_prod.png'])
...
title(' mean All fishes')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Climatol_' harv '_global_sizes_subplot_prod.png'])
