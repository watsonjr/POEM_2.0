...
% Time series plots of F vs. P with different J prefs (3 diff Sm prefs)
...
for n=1:length(ad)
    ...
    cfile = ['Dc_enc70-b200_m4-b175-k086_c20-b250_D075_J',tj(2:end),...
        '_A100_Sm075_nmort1_BE08_noCC_RE00100'];
...
print(f2,'-dpng',[ppath 'Historic3km_',harv,'_Jprefs_Sm075_FvP.png'])

save([cpath 'Historic3km_',harv,'_Jprefs_Sm075_AllBiom.png'],'all_biom',...
    'ad','cfile')
