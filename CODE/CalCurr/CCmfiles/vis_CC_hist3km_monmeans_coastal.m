...
figure(4)
plot(y,log10(sf_tmean_coast),'Linewidth',1); hold on;
plot(y,log10(mf_tmean_coast),'Linewidth',1); hold on;
plot(y,log10(sp_tmean_coast),'Linewidth',1); hold on;
plot(y,log10(mp_tmean_coast),'Linewidth',1); hold on;
plot(y,log10(lp_tmean_coast),'Linewidth',1); hold on;
plot(y,log10(sd_tmean_coast),'Linewidth',1); hold on;
plot(y,log10(md_tmean_coast),'Linewidth',1); hold on;
plot(y,log10(ld_tmean_coast),'Linewidth',1); hold on;
plot(y,log10(b_tmean_coast),'Linewidth',1); hold on;
...
stamp(harv)
print('-dpng',[ppath 'Historic3km_',harv,'_log10_all_sizes_coast.png'])
...
title(['Historic 3km ' tharv ' coastal (<200m)'])
stamp(harv)
print('-dpng',[ppath 'Historic3km_',harv,'_log10_all_types_coast.png'])
...
stamp(harv)
print('-dpng',[ppath 'Historic3km_',harv,'_CC_All_subplot_coast.png'])
