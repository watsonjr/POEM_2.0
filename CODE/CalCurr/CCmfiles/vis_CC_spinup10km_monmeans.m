...
load([fpath 'Means_Spinup10km_' harv '_' cfile '.mat']);
...
% xlim([y(1) y(end)])
% title('Spinup 10km Large Pelagics')
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Spinup10km_',harv,'_P_time.png'])
% 
% % Forage fishes
...
% xlim([y(1) y(end)])
% title('Spinup10km Forage Fishes')
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Spinup10km_',harv,'_F_time.png'])
% 
% % Demersals
% figure(3)
% subplot(4,1,1)
...
% xlim([y(1) y(end)])
% title('Spinup10km Demersal Piscivores')
% ylabel('log10 Biomass (g m^-^2)')
% legend('Larvae','Juveniles','Adults')
% legend('location','southeast')
% stamp(cfile)
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Spinup10km_',harv,'_D_time.png'])
...
% xlim([y(1) y(end)])
% title('Spinup10km Benthic Inverts')
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
%
% subplot(2,1,2)
...
% print('-dpng',[ppath 'Spinup10km_',harv,'_B_time.png'])
...
xlabel('Time (mo)')
ylabel('log10 Biomass (g m^-^2)')
title(['Spinup 10km ' harv])
stamp(cfile)
print('-dpng',[ppath 'Spinup10km_',harv,'_all_sizes.png'])
...
ylabel('log10 Biomass (g m^-^2)')
title(['Spinup 10km ' harv])
print('-dpng',[ppath 'Spinup10km_',harv,'_all_types.png'])
