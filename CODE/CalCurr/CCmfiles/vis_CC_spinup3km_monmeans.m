...
load([fpath 'Means_Spinup3km_' harv '_' cfile '.mat']);
...
% xlim([y(1) y(end)])
% title('Spinup 3km Large Pelagics')
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Spinup3km_',harv,'_P_time.png'])
% 
% % Forage fishes
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Spinup3km_',harv,'_F_time.png'])
% 
% % Demersals
% figure(3)
% subplot(4,1,1)
...
% xlim([y(1) y(end)])
% title('Spinup3km Demersal Piscivores')
% ylabel('log10 Biomass (g m^-^2)')
% legend('Larvae','Juveniles','Adults')
% legend('location','southeast')
% stamp(cfile)
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Spinup3km_',harv,'_D_time.png'])
...
% xlim([y(1) y(end)])
% title('Spinup3km Benthic Inverts')
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
%
% subplot(2,1,2)
...
% print('-dpng',[ppath 'Spinup3km_',harv,'_B_time.png'])
...
xlabel('Time (mo)')
ylabel('log10 Biomass (g m^-^2)')
title(['Spinup 3km ' harv])
stamp(cfile)
print('-dpng',[ppath 'Spinup3km_',harv,'_all_sizes.png'])
...
ylabel('log10 Biomass (g m^-^2)')
title(['Spinup 3km ' harv])
print('-dpng',[ppath 'Spinup3km_',harv,'_all_types.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Spinup3km_',harv,'_CC_BENT.png'])
...
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_BENT_mgC.png'])
%
% % sp
% figure(11)
...
% caxis([-2 1])
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_SP.png'])
% 
% % sf
% figure(12)
...
% caxis([-2 1])
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_SF.png'])
% 
% % sd
% figure(13)
...
% caxis([-2 1])
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_SD.png'])
% 
% % mp
% figure(14)
...
% caxis([-2 1])
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_MP.png'])
% 
% % mf
% figure(15)
...
% caxis([-2 1])
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_MF.png'])
% 
% % md
% figure(16)
...
% caxis([-2 1])
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_MD.png'])
% 
% % lp
% figure(17)
...
% caxis([-2 1])
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_LP.png'])
% 
% % ld
% figure(18)
...
% caxis([-2 1])
% stamp(cfile)
% print('-dpng',[ppath 'Spinup3km_',harv,'_CC_LD.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Spinup3km_',harv,'_CC_All.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Spinup3km_',harv,'_CC_AllF.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Spinup3km_',harv,'_CC_AllD.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Spinup3km_',harv,'_CC_AllP.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Spinup3km_',harv,'_CC_All_subplot.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Spinup3km_',harv,'_CC_ratios_subplot.png'])
