...
xlim([y(1) y(end)])
title('Forecast Pristine Pelagic Piscivores')
...
xlim([y(1) y(end)])
title('Forecast Pristine Forage Fishes')
xlabel('Year')
ylabel('log10 Biomass (g m^-^2)')
...
xlim([y(1) y(end)])
title('Forecast Pristine Demersal Piscivores')
ylabel('log10 Biomass (g m^-^2)')
legend('Larvae','Juveniles','Adults')
legend('location','southeast')
stamp(cfile)
...
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_all_sizes.png'])
...
ylabel('log10 Biomass (g m^-^2)')
title(['Forecast Pristine'])
print('-dpng',[ppath 'Fore_pristine_all_types.png'])
...
xlim([2006 2100])
title('Demersals')
print('-dpng',[ppath 'Fore_pristine_recruitment.png'])
...
caxis([-0.8 2.3])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_BENT_mgC.png'])
...
shading flat
title('Forecast pristine 2051-2100 P:D mean biomass(g m^-^2)')
colormap('jet')
colorbar('h')
caxis([0 1])
stamp(cfile)
...
shading flat
title('Forecast pristine 2051-2100 P:F mean biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([0 1])
stamp(cfile)
...
shading flat
title('Forecast pristine 2051-2100 log10 mean Larval P production (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_SP.png'])

% sf
figure(32)
surf(geolon_t,geolat_t,log10(Psf)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean Larval F production (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_SF.png'])

% sd
figure(33)
surf(geolon_t,geolat_t,log10(Psd)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean Larval D production (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_SD.png'])

% mp
figure(34)
surf(geolon_t,geolat_t,log10(Pmp)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean Juvenile P production (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_MP.png'])

% mf
figure(35)
surf(geolon_t,geolat_t,log10(Pmf)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean Adult F production (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_MF.png'])

% md
figure(36)
surf(geolon_t,geolat_t,log10(Pmd)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean Juvenile D production (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_MD.png'])

% lp
figure(37)
surf(geolon_t,geolat_t,log10(Plp)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean Adult P production (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_LP.png'])

% ld
figure(38)
surf(geolon_t,geolat_t,log10(Pld)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean Adult D production (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_LD.png'])
...
shading flat
title('Forecast pristine 2051-2100 log10 mean production All Fishes (g m^-^2)')
colormap('jet')
colorbar('h')
%caxis([-1 1])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_All.png'])

% all F
figure(40)
surf(geolon_t,geolat_t,log10(PAllF)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean production All F (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_AllF.png'])

% all D
figure(41)
surf(geolon_t,geolat_t,log10(PAllD)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean production All D (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_AllD.png'])

% All P
figure(42)
surf(geolon_t,geolat_t,log10(PAllP)); view(2); hold on;
shading flat
title('Forecast pristine 2051-2100 log10 mean production All P (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-5 0])
stamp(cfile)
print('-dpng',[ppath 'Fore_pristine_global_prod_AllP.png'])
