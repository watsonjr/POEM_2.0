...
#! Ocean currents
U = ncread("/Volumes/GFDL/GCM_DATA/CORE-forced/feb152013_run25_ocean.198801-200712_uh200_vh200_v2.nc","Uth_200");
V = ncread("/Volumes/GFDL/GCM_DATA/CORE-forced/feb152013_run25_ocean.198801-200712_uh200_vh200_v2.nc","Vth_200");
...
for i = 3:5#1:nyr
  ...
  #v[find(v.==minimum(v))] = 0.0
	...
	println(i)
	ti = string(1987+i);
  di = "/Volumes/GFDL/POEM_JLD/Data_hindcast_velH200_";
	save(string(di,ti[1:end],".jld"),"Uh",D_u,"Vh",D_v);
