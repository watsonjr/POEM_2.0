...
# TIME = ncread("/Volumes/GFDL/GCM_DATA/Forecast/ocean_cobalt_biomass_100.200601-210012.nlgz_100.nc",
...
TIME = ncread("/Volumes/GFDL/GCM_DATA/ESM2M_hist/ocean_cobalt_biomass_100.186101-200512.nlgz_100.nc",
	"average_T1");
LON  = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "geolon_t"); # lon
LAT  = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "geolat_t"); # lon
Z    = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "ht"); # depth
zt   = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "zt"); # depth levels
dx   = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "dxt");
dy   = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "dyt");
kmt  = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "kmt");
dxtn = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "dxtn");
dyte = ncread("/Volumes/GFDL/GCM_DATA/Hindcast/grid_spec.nc", "dyte");
dat  = dx.*dy # area in m
...
#! save
save("./Data_hindcast_grid_cp2D.jld", "TIME",TIME,"LAT",LAT,"LON",LON,"Z",Z,"AREA",dat,
