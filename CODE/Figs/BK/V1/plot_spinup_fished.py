...
#! Fish DATA
PISC = np.load("../Data/NPZ/Spinup_fished_PISC.npy")
PLAN = np.load("../Data/NPZ/Spinup_fished_PLAN.npy")
DETR = np.load("../Data/NPZ/Spinup_fished_DETR.npy")
BENT = np.load("../Data/NPZ/Spinup_fished_BENT.npy")
