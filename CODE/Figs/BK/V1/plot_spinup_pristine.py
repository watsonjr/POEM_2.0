...
#! Fish DATA
nc_pisc = netCDF4.Dataset("../Data/NC/Data_spinup_pristine_pisc.nc")
nc_plan = netCDF4.Dataset("../Data/NC/Data_spinup_pristine_plan.nc")
nc_detr = netCDF4.Dataset("../Data/NC/Data_spinup_pristine_detr.nc")
nc_bent = netCDF4.Dataset("../Data/NC/Data_spinup_pristine_bent.nc")
