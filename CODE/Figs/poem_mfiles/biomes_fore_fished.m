...
biome_mcatch00(:,1) = mf_biome_mcatch(:,12);
biome_mcatch00(:,2) = mp_biome_mcatch(:,12);
biome_mcatch00(:,3) = md_biome_mcatch(:,12);
biome_mcatch00(:,4) = lp_biome_mcatch(:,12);
biome_mcatch00(:,5) = ld_biome_mcatch(:,12);

save([dpath 'Biomes_fore_fished_' cfile '.mat'],'biome_mbio50',...
    'sf_biome_mbio','sp_biome_mbio','sd_biome_mbio','mf_biome_mbio',...
    'mp_biome_mbio','md_biome_mbio','b_biome_mbio','lp_biome_mbio',...
    'ld_biome_mbio','biome_mcatch00','mf_biome_mcatch','mp_biome_mcatch',...
