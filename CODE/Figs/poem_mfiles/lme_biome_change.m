...
figure(40)
bar(Mdiff_foref_histf(2:4)*100)
colormap(cmap2)
ylim([-40 40])
set(gca,'XTickLabel',{'Forage','Pelagic','Demersal'})
ylabel('Percent change')
xlabel('Fish type')
title('Global change in mean fish abundance (g/m^2) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'Global_fish_mean_biom_foref_histf_type.png'])

figure(41)
bar(Mdiff_foref_histf(5:7)*100)
colormap(cmap2)
ylim([-40 40])
set(gca,'XTickLabel',{'S','M','L'})
ylabel('Percent change')
xlabel('Fish size')
title('Global change in mean fish abundance (g/m^2) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'Global_fish_mean_biom_foref_histf_size.png'])

figure(42)
bar(Tdiff_foref_histf(2:4)*100)
colormap(cmap2)
ylim([-40 40])
set(gca,'XTickLabel',{'Forage','Pelagic','Demersal'})
ylabel('Percent change')
xlabel('Fish type')
title('Global change in mean fish total abundance (g) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'Global_fish_tot_biom_foref_histf_type.png'])

figure(43)
bar(Tdiff_foref_histf(5:7)*100)
colormap(cmap2)
ylim([-40 40])
set(gca,'XTickLabel',{'S','M','L'})
ylabel('Percent change')
xlabel('Fish size')
title('Global change in mean fish total abundance (g) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'Global_fish_tot_biom_foref_histf_size.png'])
...
figure(44)
bar(Mdiff_foref_histf_np(2:4)*100)
colormap(cmap2)
ylim([-40 40])
set(gca,'XTickLabel',{'Forage','Pelagic','Demersal'})
ylabel('Percent change')
xlabel('Fish type')
title('N Pac  change in mean fish abundance (g/m^2) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'NPac_fish_mean_biom_foref_histf_type.png'])

figure(45)
bar(Mdiff_foref_histf_np(5:7)*100)
colormap(cmap2)
ylim([-40 40])
set(gca,'XTickLabel',{'S','M','L'})
ylabel('Percent change')
xlabel('Fish size')
title('N Pac  change in mean fish abundance (g/m^2) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'NPac_fish_mean_biom_foref_histf_size.png'])

figure(46)
bar(Tdiff_foref_histf_np(2:4)*100)
colormap(cmap2)
ylim([-40 40])
set(gca,'XTickLabel',{'Forage','Pelagic','Demersal'})
ylabel('Percent change')
xlabel('Fish type')
title('N Pac  change in mean fish total abundance (g) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'NPac_fish_tot_biom_foref_histf_type.png'])

figure(47)
bar(Tdiff_foref_histf_np(5:7)*100)
colormap(cmap2)
ylim([-40 40])
set(gca,'XTickLabel',{'S','M','L'})
ylabel('Percent change')
xlabel('Fish size')
title('N Pac  change in mean fish total abundance (g) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'NPac_fish_tot_biom_foref_histf_size.png'])
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
set(gcf,'renderer','painters')
title('Ocean Biomes Forecast')
axesmui
print('-dpng',[cpath 'biomes_forecast.png'])
...
legend('location','southeast')
title('N Pac change in mean fish total abundance (g) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'NPacBiome_fish_tot_biom_foref_histf_type.png'])
...
legend('location','northeast')
title('N Pac change in mean fish total abundance (g) from 1950-2000 to 2050-2100')
print('-dpng',[ppath 'NPacBiome_fish_tot_biom_foref_histf_size.png'])
...
ylabel('Percent change')
%xlabel('Driver')
legend('Industrial CO_2','Fishing','Climate Change + Fishing')
legend('location','southwest')
title('Global change in mean fish abundance (g/m^2)')
...
subplot(1,3,2)
bar([Tdiff(8:11,2:4)]'*100)
colormap(cmap3)
ylim([-60 40])
set(gca,'XTickLabel',{'F','P','D'})
ylabel('Percent change')
title({'N Pac change in mean fish total abundance (g)';'Fishing'})
subplot(1,3,3)
bar([Tdiff(12:15,2:4)]'*100)
colormap(cmap3)
ylim([-60 40])
set(gca,'XTickLabel',{'F','P','D'})
ylabel('Percent change')
title('Climate Change + Fishing')
print('-dpng',[ppath 'NPacBiome_fish_tot_biom_type.png'])

figure(38)
subplot(1,3,1)
bar([Tdiff(4:7,5:7)]'*100)
colormap(cmap3)
ylim([-80 100])
set(gca,'XTickLabel',{'S','M','L'})
ylabel('Percent change')
