...
save([dpath 'LME_fore_fished_' cfile '.mat'],...
    ...
    'lme_mcatch00','mf_lme_mcatch','mp_lme_mcatch','md_lme_mcatch',...
    'lp_lme_mcatch','ld_lme_mcatch');
...
set(gcf,'renderer','painters')
title('2050-2100 mean log10 total annual catch (MT) All Fishes')
stamp(cfile)
...
set(gcf,'renderer','painters')
title('2050-2100 mean log10 total annual catch (MT) Forage Fishes')
stamp(cfile)
...
ylim(hcb,[3 6.5])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('2050-2100 mean log10 total annual catch (MT) Pelagic Fishes')
stamp(cfile)
...
ylim(hcb,[3 6.5])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('2050-2100 mean log10 total annual catch (MT) Demersal Fishes')
stamp(cfile)
...
ylim(hcb,[3 6.5])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('2050-2100 mean log10 total annual catch (MT) Medium Fishes')
stamp(cfile)
...
ylim(hcb,[3 6.5])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('2050-2100 mean log10 total annual catch (MT) Large Fishes')
stamp(cfile)
