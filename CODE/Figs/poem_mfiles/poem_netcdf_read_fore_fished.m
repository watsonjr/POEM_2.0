...
%% SP
ncid = netcdf.open([fpath 'Data_fore_fished_sml_p.nc'],'NC_NOWRITE');
...
%% SF
ncid = netcdf.open([fpath 'Data_fore_fished_sml_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% SD
ncid = netcdf.open([fpath 'Data_fore_fished_sml_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MP
ncid = netcdf.open([fpath 'Data_fore_fished_med_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MF
ncid = netcdf.open([fpath 'Data_fore_fished_med_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MD
ncid = netcdf.open([fpath 'Data_fore_fished_med_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% LP
ncid = netcdf.open([fpath 'Data_fore_fished_lrg_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% LD
ncid = netcdf.open([fpath 'Data_fore_fished_lrg_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% Benthic material
ncid = netcdf.open([fpath 'Data_fore_fished_bent.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%%
save([fpath 'Means_fore_fished_' cfile '.mat'],...
    ...
    'ld_tcatch','sf_mean5000','sp_mean5000','sd_mean5000','mf_mean5000',...
    'mp_mean5000','md_mean5000','b_mean5000','lp_mean5000','ld_mean5000',...
    'sf_prod5000','sp_prod5000','sd_prod5000','mf_prod5000','mp_prod5000',...
    'md_prod5000','lp_prod5000','ld_prod5000','mf_mcatch5000','mp_mcatch5000',...
    'md_mcatch5000','lp_mcatch5000','ld_mcatch5000','mf_tcatch5000',...
    'mp_tcatch5000','md_tcatch5000','lp_tcatch5000','ld_tcatch5000');
