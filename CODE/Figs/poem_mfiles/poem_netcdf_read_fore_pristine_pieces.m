...
%% second part
%% SP 
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_sml_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
%% SF
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_sml_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% SD
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_sml_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MP
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_med_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MF
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_med_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MD
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_med_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% LP
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_lrg_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% LD
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_lrg_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
%% Benthic material
ncid = netcdf.open([fpath 'Data_fore_pristine2086-2100_bent.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%% Put together
SF.bio(:,961:1140)=SF.bio2;
SP.bio(:,961:1140)=SP.bio2;
SD.bio(:,961:1140)=SD.bio2;
MF.bio(:,961:1140)=MF.bio2;
MP.bio(:,961:1140)=MP.bio2;
MD.bio(:,961:1140)=MD.bio2;
BENT.bio(:,961:1140)=BENT.bio2;
LP.bio(:,961:1140)=LP.bio2;
LD.bio(:,961:1140)=LD.bio2;

SF.prod(:,961:1140)=SF.prod2;
SP.prod(:,961:1140)=SP.prod2;
SD.prod(:,961:1140)=SD.prod2;
MF.prod(:,961:1140)=MF.prod2;
MP.prod(:,961:1140)=MP.prod2;
MD.prod(:,961:1140)=MD.prod2;
LP.prod(:,961:1140)=LP.prod2;
LD.prod(:,961:1140)=LD.prod2;

SF.rec(:,961:1140)=SF.rec2;
SP.rec(:,961:1140)=SP.rec2;
SD.rec(:,961:1140)=SD.rec2;
MF.rec(:,961:1140)=MF.rec2;
MP.rec(:,961:1140)=MP.rec2;
MD.rec(:,961:1140)=MD.rec2;
LP.rec(:,961:1140)=LP.rec2;
LD.rec(:,961:1140)=LD.rec2;
...
%%
save([fpath 'Means_fore_pristine_' cfile '.mat'],...
