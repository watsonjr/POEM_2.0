...
%% SP
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_sml_p.nc'],'NC_NOWRITE');
...
%% SF
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_sml_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% SD
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_sml_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MP
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_med_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MF
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_med_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MD
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_med_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LP
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_lrg_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LD
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_lrg_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%% Benthic material
ncid = netcdf.open([fpath 'Data_hist_pristine1860-1960_bent.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%% second part
%% SP 
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_sml_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
...
%% SF
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_sml_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% SD
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_sml_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MP
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_med_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MF
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_med_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% MD
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_med_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% LP
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_lrg_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
% LD
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_lrg_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    if (strcmp(varname,'catch'))
...
%% Benthic material
ncid = netcdf.open([fpath 'Data_hist_pristine1961-2005_bent.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%% Put together
SF.bio(:,1201:1740)=SF.bio2;
SP.bio(:,1201:1740)=SP.bio2;
SD.bio(:,1201:1740)=SD.bio2;
MF.bio(:,1201:1740)=MF.bio2;
MP.bio(:,1201:1740)=MP.bio2;
MD.bio(:,1201:1740)=MD.bio2;
BENT.bio(:,1201:1740)=BENT.bio2;
LP.bio(:,1201:1740)=LP.bio2;
LD.bio(:,1201:1740)=LD.bio2;

SF.prod(:,1201:1740)=SF.prod2;
SP.prod(:,1201:1740)=SP.prod2;
SD.prod(:,1201:1740)=SD.prod2;
MF.prod(:,1201:1740)=MF.prod2;
MP.prod(:,1201:1740)=MP.prod2;
MD.prod(:,1201:1740)=MD.prod2;
LP.prod(:,1201:1740)=LP.prod2;
LD.prod(:,1201:1740)=LD.prod2;

SF.rec(:,1201:1740)=SF.rec2;
SP.rec(:,1201:1740)=SP.rec2;
SD.rec(:,1201:1740)=SD.rec2;
MF.rec(:,1201:1740)=MF.rec2;
MP.rec(:,1201:1740)=MP.rec2;
MD.rec(:,1201:1740)=MD.rec2;
LP.rec(:,1201:1740)=LP.rec2;
LD.rec(:,1201:1740)=LD.rec2;
