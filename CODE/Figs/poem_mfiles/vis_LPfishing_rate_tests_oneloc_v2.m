...
%         '_' pref '_nmort'  nmort '_BE05_RE' REfn '_LP_fish' F];
    dp = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
        '_MZ01_nmort'  nmort '_BE05_RE' REfn '_BAassim_LP_fish' F];
    dpath = [datap char(dp) '/'];
    fpath = [figp char(dp) '/'];
    cfile = char(dp);
%     cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
%         '_' pref '_nmort'  nmort '_BE05_RE' REfn '_LP_fishing_catch'];
    cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
            '_MZ01_nmort'  nmort '_BE05_RE' REfn '_BAassim_LP_fishing_catch'];
