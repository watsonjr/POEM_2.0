...
sims = {'0.1','0.05','0.01','5e-3','4e-3','3e-3','2e-3','1e-3','5e-4','1e-4'};
rfrac = {'0100','0050','0010','00050','00040','00030','00020','00010','00005','00001'};
fcrit = 40;
nmort = 'M2';
kad = 100;
pref = 'D050'; 
...
%             '_LD_fish01'];
%         dp = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
%             '_' pref '_nmort'  nmort '_BE05_RE' num2str(RE) '_LP_fish000'];
        dp = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
            '_MZ01_nmort'  nmort '_BE05_RE' num2str(RE) '_BAassim_MF_fish000']; 
        cfile = char(dp);
%         cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
%             '_MZ01_nmort'  nmort '_BE05_K' num2str(kad) '_FishingREtests'];
%         cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
%             '_' pref '_nmort'  nmort '_BE05_REtests'];
        cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
            '_MZ01_nmort'  nmort '_BE05_BAassim_REtests'];
        dpath = [char(dp) '/'];
...
%             '_' pref '_nmort'  nmort '_BE05_REtests'];
        ...
        f19=figure(19);
        subplot(4,3,i)
        plot(s,log10(sumspec(i)),'k.','MarkerSize',15); hold on;
        xlim([0 ndp+1])
        ylim([-2 1])
        set(gca,'XTick',1:ndp,'XTickLabel',[])
        if (s==ndp)
...
print(f18,'-dpng',[figp sname sname2 cfile2 '_tot_mean_biomass_type_all_locs_axes.png'])
print(f19,'-dpng',[figp sname sname2 cfile2 '_tot_mean_biomass_spec_all_locs.png'])
