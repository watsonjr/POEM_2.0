...
title('Forecast fished')
print('-dpng',[ppath 'Fore_fished_ts_mbio_type.png'])
...
title('Forecast fished')
print('-dpng',[ppath 'Fore_fished_ts_mbio_typeLog.png'])
...
title('Forecast fished')
print('-dpng',[ppath 'Fore_fished_ts_mcatch_type.png'])
...
title('Forecast fished')
print('-dpng',[ppath 'Fore_fished_ts_mcatch_typeLog.png'])
...
m_grid;
title('2051-2100 log10 mean benthic biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean Larval P biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean Larval F biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean Larval D biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean Juvenile P biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
title('2051-2100 log10 mean Adult F biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean Juvenile D biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
title('2051-2100 log10 mean Adult P biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
m_grid;
%m_text(-111,5,'EEP','Color','black','HorizontalAlignment','center');
title('2051-2100 log10 mean Adult D biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-4 2])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean biomass All F (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-2 1])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean biomass All D (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-2 1])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean biomass All P (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([-2 1])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 P:D mean biomass(g m^-^2)')
colormap('jet')
colorbar('h')
caxis([0 1])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 P:F mean biomass (g m^-^2)')
colormap('jet')
colorbar('h')
caxis([0 1])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 (P+F):D mean biomass(g m^-^2)')
colormap('jet')
colorbar('h')
caxis([0 1])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean Juvenile P annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
%m_plot(-111,5,'o','w','MarkerSize',10);
%m_text(-111,5,'EEP','Color','red','HorizontalAlignment','center');
title('2051-2100 log10 mean Adult F annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean Juvenile D annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
m_grid;
%m_text(-111,5,'EEP','Color','black','HorizontalAlignment','center');
title('2051-2100 log10 mean Adult P annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
m_grid;
%m_text(-111,5,'EEP','Color','black','HorizontalAlignment','center');
title('2051-2100 log10 mean Adult D annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean annual catch (MT) All F')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean annual catch (MT) All D')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean annual catch (MT) All P')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean annual catch (MT) All M')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('2051-2100 log10 mean annual catch (MT) All L')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
