...
mf_tcatch(:,17:18) = [mf_tcatch5000, mf_tcatch5505];
mp_tcatch(:,17:18) = [mp_tcatch5000, mp_tcatch5505];
md_tcatch(:,17:18) = [md_tcatch5000, md_tcatch5505];
lp_tcatch(:,17:18) = [lp_tcatch5000, lp_tcatch5505];
ld_tcatch(:,17:18) = [ld_tcatch5000, ld_tcatch5505];
...
Amf_tcatch = (mf_tcatch .* repmat(area,1,18)) /50; %total fish catch per yr
Amp_tcatch = (mp_tcatch .* repmat(area,1,18)) /50;
Amd_tcatch = (md_tcatch .* repmat(area,1,18)) /50;
Alp_tcatch = (lp_tcatch .* repmat(area,1,18)) /50;
Ald_tcatch = (ld_tcatch .* repmat(area,1,18)) /50;

%
Cmp=griddata(grid(:,2),grid(:,3),Amp_mcatch(:,17),X,Y);
Cmf=griddata(grid(:,2),grid(:,3),Amf_mcatch(:,17),X,Y);
Cmd=griddata(grid(:,2),grid(:,3),Amd_mcatch(:,17),X,Y);
Clp=griddata(grid(:,2),grid(:,3),Alp_mcatch(:,17),X,Y);
Cld=griddata(grid(:,2),grid(:,3),Ald_mcatch(:,17),X,Y);
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_BENT.png'])
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_SP.png'])
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_SF.png'])
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_SD.png'])
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_MP.png'])
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_MF.png'])
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_MD.png'])
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_LP.png'])
...
caxis([-4 2])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_LD.png'])
...
caxis([-1 1])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_All.png'])
...
caxis([-2 1])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_AllF.png'])
...
caxis([-2 1])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_AllD.png'])
...
caxis([-2 1])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_AllP.png'])
...
caxis([0 1])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_FracPD.png'])
...
caxis([0 1])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_FracPF.png'])
...
caxis([0 1])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_FracPFvD.png'])
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('1950-2000 log10 mean Juvenile P annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_MP.png'])
...
%m_plot(-111,5,'o','w','MarkerSize',10);
%m_text(-111,5,'EEP','Color','red','HorizontalAlignment','center');
title('1950-2000 log10 mean Adult F annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_MF.png'])
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('1950-2000 log10 mean Juvenile D annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_MD.png'])
...
m_grid;
%m_text(-111,5,'EEP','Color','black','HorizontalAlignment','center');
title('1950-2000 log10 mean Adult P annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_LP.png'])
...
m_grid;
%m_text(-111,5,'EEP','Color','black','HorizontalAlignment','center');
title('1950-2000 log10 mean Adult D annual catch (MT)')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_LD.png'])
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('1950-2000 log10 mean annual catch (MT) All Fishes')
colormap('jet')
colorbar('h')
caxis([1 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_All.png'])
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('1950-2000 log10 mean annual catch (MT) All F')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_AllF.png'])
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('1950-2000 log10 mean annual catch (MT) All D')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_AllD.png'])
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('1950-2000 log10 mean annual catch (MT) All P')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_AllP.png'])
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('1950-2000 log10 mean annual catch (MT) All M')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_AllM.png'])
...
m_coast('patch',[.5 .5 .5],'edgecolor','none');
m_grid;
title('1950-2000 log10 mean annual catch (MT) All L')
colormap('jet')
colorbar('h')
caxis([0 5])
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_global_catch_AllL.png'])
...
Cmp2(gid)=Amp_mcatch(:,17);
Cmf2(gid)=Amf_mcatch(:,17);
Cmd2(gid)=Amd_mcatch(:,17);
Clp2(gid)=Alp_mcatch(:,17);
Cld2(gid)=Ald_mcatch(:,17);
...
title('1950-2000 log10 mean biomass All Fishes (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_All.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_AllF.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_AllP.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_AllD.png'])
...
title('1950-2000 log10 mean annual catch (MT) All Fishes')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_catch_All.png'])
...
set(gcf,'renderer','painters')
title('1950-2000 log10 mean annual catch (MT) Forage Fishes')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_catch_AllF.png'])
...
ylim(hcb,[0 5])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('1950-2000 log10 mean annual catch (MT) Pelagic Fishes')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_catch_AllP.png'])
...
ylim(hcb,[0 5])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('1950-2000 log10 mean annual catch (MT) Demersal Fishes')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_catch_AllD.png'])
...
ylim(hcb,[0 5])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('1950-2000 log10 mean annual catch (MT) Medium Fishes')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_catch_AllM.png'])
...
ylim(hcb,[0 5])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('1950-2000 log10 mean annual catch (MT) Large Fishes')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_Pac_catch_AllL.png'])
