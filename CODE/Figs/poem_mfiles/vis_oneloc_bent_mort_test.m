...
dp = ['NoDc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
        '_BentMortMed_' pref '_nmort'  nmort '_BE' BE '_RE0100'];
    dpath = [datap char(dp) '/'];
    fpath = [figp char(dp) '/'];
    cfile = char(dp);
    cfile2 = ['NoDc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
        '_BentMortMed_' pref '_nmort'  nmort '_BE' BE '_RE0100_BentMortTests'];
%%
...
for i=1:length(spots)
    ...
    loc = spots{i};
    lname = [sname2 loc '_'];
    dp = 'Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit40_BentMortMed_D100_nmortM2_BE05_RE0100';
    cfile2 = 'Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit40_BentMortMed_D100_nmortM2_BE05_RE0100';
    dpath = [char(dp) '/'];
