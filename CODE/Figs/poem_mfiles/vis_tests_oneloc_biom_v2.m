...
sims = {'0.1','0.05','0.01','5e-3','1e-3','5e-4','1e-4','5e-5','1e-5'};
rfrac = {'0100','0050','0010','00050','00010','00005',...
    '00001','000005','000001'};
fcrit = 40;
nmort = 'PW2';
kad = 100;
...
%             '_LD_fish01'];
%         dp = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
%             '_' pref '_nmort'  nmort '_BE05_RE' num2str(RE) '_LD_fish01'];
        dp = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
            '_MZ01_nmort'  nmort '_BE05_RE' num2str(RE) '_BAassim_LD_fish01']; 
        cfile = char(dp);
%         cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
%             '_MZ01_nmort'  nmort '_BE05_K' num2str(kad) '_FishingREtests'];
%         cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
%             '_' pref '_nmort'  nmort '_BE05_FishingREtests'];
        cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
            '_MZ01_nmort'  nmort '_BE05_BAassim_FishingREtests'];
        dpath = [char(dp) '/'];
...
%             '_' pref '_nmort'  nmort '_BE05_FishingREtests'];
        cfile2 = ['Dc_TrefO_Hartvig_cmax-metab_MFeqMP_fcrit' num2str(fcrit) ...
            '_MZ01_nmort'  nmort '_BE05_BAassim_LD_FishingREtests'];
        dpath = [char(dp) '/'];
        load([datap dpath sname sname2 'lastyr_sum_mean_biom']);
