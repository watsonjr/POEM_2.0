...
for L = 1:length(ids);
    ...
    save(['/Volumes/GFDL/CSV/Matlab_new_size/',simname,'/baserun_lowIC_jhp2_log_' loc '.mat'],'result')
    %! Plot
    plotPoem_1D(param, result)
    print('-dpng',['/Users/cpetrik/Dropbox/Princeton/POEM_2.0/CODE/Figs/PNG/Matlab_New_sizes/baserun_lowIC_jhp2_log_' simname '_' loc])
