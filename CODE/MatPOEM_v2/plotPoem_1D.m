function plotPoem_1D(param, result)
...
hold on
loglog(param.wc(3:5), y(:,3:5),'-','color',purp, 'linewidth',2)
loglog(param.wc(6:7), y(:,6:7),'r-', 'linewidth',2)
loglog(param.wc(8:10), y(:,8:10),'b-', 'linewidth',2)
loglog(param.wc(11:13), y(:,11:13),'k-', 'linewidth',2)
xlim(xlimit)
%ylim([1e-6 1]*max(y(:)));
ylim([1e-3 1e3]);
%set(gca,'XTickLabel','')
