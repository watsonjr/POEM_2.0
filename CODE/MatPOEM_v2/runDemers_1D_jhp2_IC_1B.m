...
for L = 1:length(ids);
    ...
    %! Save
    save([dpath,simname0,'/Demers_1B_lowIC_jhp2_log_' loc '.mat'],'B','fl','C')
    ...
    legend('MF','LP','LD')
    xlabel('Demers pref on pelagic')
    ylabel('log10 Biomass')
    print('-dpng',[fpath,'Demers_biom_1B_lowIC_jhp2_log_' simname0 '_' loc])
    ...
    title('L')
    set(gca,'XTickLabel',C)
    print('-dpng',[fpath,'Demers_flev_1B_lowIC_jhp2_' simname0 '_' loc])
end
%%
