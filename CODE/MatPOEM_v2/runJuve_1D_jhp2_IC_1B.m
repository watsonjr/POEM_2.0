...
for L = 1:length(ids);
    ...
    %! Save
    save([dpath,simname0,'/Juve_1B_lowIC_jhp2_log_asc_' loc '.mat'],'B','fl','C')
    ...
    legend('MF','LP','LD')
    xlabel('Juve pref reduction')
    ylabel('log10 Biomass')
    print('-dpng',[fpath,'Juve_biom_1B_lowIC_jhp2_log_asc_' simname0 '_' loc])
    ...
    title('L')
    set(gca,'XTickLabel',C)
    print('-dpng',[fpath,'Juve_flev_1B_lowIC_jhp2_asc_' simname0 '_' loc])
end
%%
