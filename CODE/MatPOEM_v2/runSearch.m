...
for L = 9%1:length(ids);
    ...
    %! Save
    save([dpath,simname0,'/Search_log_' loc '.mat'],'B','fl','C')
    ...
    print('-dpng',[fpath,'Search_log_' simname0 '_' loc])
    ...
    title('L')
    set(gca,'XTickLabel',C)
    print('-dpng',[fpath,'Search_flev_log_' simname0 '_' loc])
end
%%
