...
for L = 1:length(ids);
    ...
    %! Save
    save([dpath,simname0,'/Small_1B_lowIC_jhp2_log_' loc '.mat'],'B','fl','C')
    ...
    print('-dpng',[fpath,'Small_biom_1B_lowIC_jhp2_log_' simname0 '_' loc])
    ...
    title('L')
    set(gca,'XTickLabel',C)
    print('-dpng',[fpath,'Small_flev_1B_lowIC_jhp2_' simname0 '_' loc])
end
%%
