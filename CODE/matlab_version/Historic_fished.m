...
%% ! Initialize
init_sim = 'Dc_enc70_cmax-metab20_fcrit20_D075_J100_A050_Sm025_nmort1_BE05_CC050_lgRE00100_mdRE00400';
...
file_sml_f = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_sml_f.nc'];
file_sml_p = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_sml_p.nc'];
file_sml_d = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_sml_d.nc'];
file_med_f = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_med_f.nc'];
file_med_p = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_med_p.nc'];
file_med_d = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_med_d.nc'];
file_lrg_p = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_lrg_p.nc'];
file_lrg_d = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_lrg_d.nc'];
file_bent  = ['/Volumes/GFDL/NC/Matlab_new_size/',simname, '/Hindcast_fished',tfish(2:end),'_bent.nc'];
...
for YR = 1:YEARS % years
    ...
    for DAY = 1:DT:DAYS % days
        ...
        %%%! Future time step
        DY = int64(ceil(DAY));
        [num2str(bpow),' , ',num2str(kt),' , ',num2str(YR),' , ',num2str(mod(DY,365))]
