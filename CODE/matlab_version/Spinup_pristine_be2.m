...
if (harv==1)
    ...
    simname = [coup,'_2B_enc',tefn,'_cmax-metab',tcfn,'_fcrit',tfcrit,'_D',td(2:end),'_J',tj(2:end),'_A',ta(2:end),'_Sm',tsm(2:end),'_nmort',tmort,'_BE',tbe(2:end),'_CC',tcc(2:end),'_lgRE',tre(2:end),'_mdRE',tre2(2:end),'_',sel,'_fish',tfish(2:end)];
    ...
    simname = [coup,'_2B_enc',tefn,'_cmax-metab',tcfn,'_fcrit',tfcrit,'_D',td(2:end),'_J',tj(2:end),'_A',ta(2:end),'_Sm',tsm(2:end),'_nmort',tmort,'_BE',tbe(2:end),'_CC',tcc(2:end),'_lgRE',tre(2:end),'_mdRE',tre2(2:end)];
...
vidbioSB    = netcdf.defVar(ncidB,'Sbiomass','double',[xy_dim,time_dim]);
vidbioMB    = netcdf.defVar(ncidB,'Mbiomass','double',[xy_dim,time_dim]);
...
for YR = 1:YEARS % years
    ...
    for i = 1:12
        ...
        netcdf.putVar(ncidB,vidbioSB,[0 MNT-1],[NX 1],mean(S_Bent_Sbio(:,a(i):b(i)),2));
        netcdf.putVar(ncidB,vidbioMB,[0 MNT-1],[NX 1],mean(S_Bent_Mbio(:,a(i):b(i)),2));
