...
% Forecast time period (2006-2100) in Gulf of Mexico
% 95 years
% Saved as mat files
...
load([fpath 'GoMex_ts_means_bio_prod_fish_Forecast_' harv '_' cfile '.mat']);
...
stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_all_sizes.png'])
...
ylabel('log_1_0 Biomass (g m^-^2)')
title(['Forecast fished'])
print('-dpng',[ppath 'Fore_',harv,'_GoMex_all_types.png'])
...
title('Forecast fished')
print('-dpng',[ppath 'Fore_',harv,'_GoMex_ts_mbio.png'])
...
title('Forecast fished 2051-2100 log_1_0 mean benthic biomass (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_BENT.png'])
...
set(gcf,'renderer','painters')
title('Forecast fished 2051-2100 log_1_0 mean biomass All Fishes (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_All.png'])
...
set(gcf,'renderer','painters')
title('Forecast fished 2051-2100 log_1_0 mean biomass All F (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_AllF.png'])
...
ylim(hcb,[-1 1])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Forecast fished 2051-2100 log_1_0 mean biomass All D (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_AllD.png'])
...
ylim(hcb,[-1 1])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Forecast fished 2051-2100 log_1_0 mean biomass All P (g m^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_AllP.png'])
...
%stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_All_subplot.png'])
...
%stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_Bent_subplot.png'])
...
%stamp(cfile)
print('-dpng',[ppath 'Fore_',harv,'_GoMex_ratios_subplot.png'])


%% Save
save([fpath 'Map_vals_Forecast_',harv,'_' cfile '.mat'],'b_tmean',...
