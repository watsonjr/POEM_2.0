...
title('Historic 1990-1995 LME mean ratio P:D biomass (g)')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_',harv,'_LME_ratioPD_biom.png'])
...
ylim(hcb,[0 1])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Historic 1990-1995 LME mean ratio P:D catch (g)')
stamp(cfile)
%print('-dpng',[ppath 'Hist_fished_',harv,'_LME_ratioPD_catch.png'])
...
ylim(hcb,[0 1])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Historic 1990-1995 LME mean ratio P:D catch (MT km^-^2)')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_',harv,'_LME_ratioPD_catch_mtkm2.png'])
...
%stamp([harv '_' cfile])
print('-dpng',[ppath 'Hist_fished_' harv '_LME_ratios_subplot.png'])
