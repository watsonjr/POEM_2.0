...
load([nfile 'Climatol_All_fish03_means_param_sens_10p.mat'])
%ptext{29}='kap75';
...
D = SD + MD + LD;
All = F + P + D;
% log10 diff total biomass of each group
v1 = log10(nanmean(F)) - log10(nanmean(F(:,1)));
v2 = log10(nanmean(P)) - log10(nanmean(P(:,1)));
v3 = log10(nanmean(D)) - log10(nanmean(D(:,1)));
% Total biomass
v4 = log10(nanmean(All)) - log10(nanmean(All(:,1)));
...
v5 = log10(eq) - log10(eq(:,1)) ;
v6 = log10(pol) - log10(pol(:,1)) ;
...
writetable(vtab,[nfile 'Climatol_All_fish03_param_sens_10p_vecs_log10.csv'],...
    'WriteRowNames',true)
