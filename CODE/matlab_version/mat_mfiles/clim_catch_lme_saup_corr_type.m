...
for b=1%:length(bees)
    for k = 1%:length(kays)
        ...
        %axis([0 8 0 8])
        xlabel('SAUP catch (MT km^-^2) mean of top 10 years')
        ylabel('POEM catch (MT km^-^2) mean of Climatology')
        title('Mean catch')
        ...
        %axis([0 8 0 8])
        xlabel('SAUP F catch (MT km^-^2)')
        ylabel('POEM F catch (MT km^-^2)')
        title('Mean F catch')
        ...
        %axis([0 8 0 8])
        xlabel('SAUP P catch (MT km^-^2)')
        ylabel('POEM P catch (MT km^-^2)')
        title('Mean P catch')
        ...
        %axis([0 8 0 8])
        xlabel('SAUP D catch (MT km^-^2)')
        ylabel('POEM D catch (MT km^-^2)')
        title('Mean D catch')
        stamp(cfile)
        ...
        %axis([3 8 3 8])
        xlabel('SAUP catch (MT km^-^2) mean of top 10 years')
        ylabel('Total mean of Climatology')
...
title('Corr D')
stamp(cfile2)
%print('-dpng',[pp 'Clim_fished',harv,'_LME_SAUP_catch_corr_b_k'])
...
title('RMSE D')
stamp(cfile2)
print('-dpng',[pp 'Clim_fished',harv,'_LME_SAUP_catch_rmse_b_k'])
