...
save([dp 'Clim_fished',harv,'_LME_SAUP_catch_comp_b_k.mat'],'rall','rF','rP',...
    'rD','rmse','rmseF','rmseP','rmseD')

%% Plots of r and RMSE
cfile2 = ['Clim_fished',harv,'_Dc_enc70_cmax-metab20_fcrit20_D075_J100_A050_Sm025_nmort1_BE05_CC050_lgRE00100_mdRE00100'];

kays2 = 0.0405:0.01:0.135;
...
title('Corr D')
stamp(cfile2)
print('-dpng',[pp 'Clim_fished',harv,'_LME_SAUP_l10catch_corr_b_k'])
...
title('RMSE D')
stamp(cfile2)
print('-dpng',[pp 'Clim_fished',harv,'_LME_SAUP_l10catch_rmse_b_k'])
...
max(corr_PD(:)) %k=0.09;b=0.225

rmse_PD = normalize(rmseP)+normalize(rmseD);
min(rmse_PD(:)) %k=0.11;b=0.25
