...
figure(100)
for i=1:66
    plot(i,i,'.','color',tmap(tid(i,2),:)); hold on;
end
...
% 
% harv = '03';
% for k = 6;%1:length(kays)
%     kt = kays(k);
%     
%     for b = 3;%1:length(bees)
%         bpow = bees(b);
%         
...
%         
        cfile = 'Dc_enc70_cmax-metab20_b18_k09_fcrit20_D075_J100_A050_Sm025_nmort1_BE05_CC050_lgRE00100_mdRE00100';
        charv = ['fish_F01_P03_D06'];
        harv = '_F01_P03_D06';
        ...
        ylabel('POEM catch (MT) mean of Climatology')
        title('Mean catch')
        ...
        text(3.25,7.5,['r = ' num2str(rall)])
        text(3.25,7.0,['RMSE = ' num2str(rmse)])
        axis([3 8 3 8])
        xlabel('SAUP catch (MT) mean of top 10 years')
        ...
        text(0.25,7.5,['r = ' num2str(rF)])
        text(0.25,7.0,['RMSE = ' num2str(rmseF)])
        axis([0 8 0 8])
        xlabel('SAUP F catch (MT)')
        ylabel('POEM F catch (MT)')
        title('Mean F catch')
        ...
        text(1.25,7.5,['r = ' num2str(rP)])
        text(1.25,7.0,['RMSE = ' num2str(rmseP)])
        axis([1 8 1 8])
        xlabel('SAUP P catch (MT)')
        ylabel('POEM P catch (MT)')
        title('Mean P catch')
        ...
        text(1.25,7.5,['r = ' num2str(rD)])
        text(1.25,7.0,['RMSE = ' num2str(rmseD)])
        axis([1 8 1 8])
        xlabel('SAUP D catch (MT)')
        ylabel('POEM D catch (MT)')
        title('Mean D catch')
