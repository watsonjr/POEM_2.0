...
% rmse
subplot(2,2,2)
pcolor(egrid,cgrid,squeeze(rmse2))
colormap(cmap_revt)
colorbar
caxis([0.33 0.37])
set(gca,'XTick',bees,'XTickLabel',bees,...
...
stamp([harv '_' cfile])
print('-dpng',[pp cfile2 '_CmaxBE_SAUP_Pfrac_stats.png'])

cp = '/Volumes/GFDL/CSV/Matlab_new_size/';
save([cp 'Bio_rates/' cfile2 '_clim_',harv,'_SAUP_Pfrac_comp_CmaxBE.mat']);
