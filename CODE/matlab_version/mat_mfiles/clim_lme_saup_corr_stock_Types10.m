...
%Use top 10 years from each type
%   MAKES CORRELATIONS OF F AND P WORSE
...
for i=1:66
    ...
    [sort_Flme_catch,iy] = sort(Flme_catch_all(:,i),'descend');
    [sort_Plme_catch,ip] = sort(Plme_catch_all(:,i),'descend');
    [sort_Dlme_catch,id] = sort(Dlme_catch_all(:,i),'descend');
...
writetable(T1,[dpath 'LME_prod_catch_SAUP_mtkm2_types10_' cfile '.csv'],'Delimiter',',')
writetable(T2,[dpath 'LME_prod_catch_SAUP_gCm2_types10_' cfile '.csv'],'Delimiter',',')
save([dpath 'LME_prod_catch_SAUP_types10_' cfile '.mat'],'tab','tab2')
...
writetable(Fstat,[dpath 'LME_SAUP_stats_types10_' cfile '.csv'],'Delimiter',',',...
    'WriteRowNames',true)
save([dpath 'LME_SAUP_stats_types10_' cfile '.mat'],'fish_stat')
...
title('Mean D catch')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_types_temp_Stock_LELC_types10.png'])
...
title('C. Demersals')
% stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_types_temp_Stock_LELC_ms_types10.png'])
...
title('Demersals')
% stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_types_temp_Stock_LELC_ppt_types10.png'])
...
title('All fishes')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_temp_Stock_ppt_types10.png'])
...
title('All fishes')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_temp_Stock_LELC_ppt_types10.png'])
...
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_fracP_types10.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Clim_' harv '_LME_fracPD_catch_SAUP_comp_types10.png'])
...
title('Fraction Large Pelagics')
stamp(cfile)
print('-dpng',[ppath 'Clim_' harv '_LME_fracPD_catch_SAUP_comp_subplot_types10.png'])
