...
%%
print(f1,'-dpng',[ppath 'Clim_fish03_SAUP_comp_Stock_LELC_kt_BE_F.png'])
print(f2,'-dpng',[ppath 'Clim_fish03_SAUP_comp_Stock_LELC_kt_BE_P.png'])
print(f3,'-dpng',[ppath 'Clim_fish03_SAUP_comp_Stock_LELC_kt_BE_D.png'])
print(f4,'-dpng',[ppath 'Clim_fish03_SAUP_comp_Stock_LELC_kt_BE_All.png'])
print(f5,'-dpng',[ppath 'Clim_fish03_SAUP_comp_Stock_LELC_kt_BE_PD.png'])
print(f6,'-dpng',[ppath 'Clim_fish03_SAUP_comp_Stock_LELC_kt_BE_PD_DvD.png'])
...
set(gca,'YTick',bees(1:2:end)+0.0125,'YTickLabel',bees(1:2:end),...
        'XTick',ktemp(1:2:end)+0.0025,'XTickLabel',[0.08:0.01:0.10])
...
colorbar('Position',[0.365 0.325 0.3 0.03],'orientation','horizontal')
colormap(cmYOR)
caxis([0 1])
xlabel('k_M')
title('DvD P/(P+D)')
set(gca,'YTick',bees(1:2:end)+0.0125,'YTickLabel',bees(1:2:end),...
        'XTick',ktemp(1:2:end)+0.0025,'XTickLabel',[0.08:0.01:0.10])
print('-dpng',[ppath 'Clim_fish03_SAUP_comp_Stock_LELC_kt_BE_pcolor_corrs.png'])    
...
set(gca,'YTick',bees(1:2:end)+0.0125,'YTickLabel',bees(1:2:end),...
        'XTick',ktemp(1:2:end)+0.0025,'XTickLabel',[0.08:0.01:0.10])
print('-dpng',[ppath 'Clim_fish03_SAUP_comp_Stock_LELC_kt_BE_pcolor_rmse.png'])    
