...
load([spath 'SAUP_LME_Catch_annual_no_elasmo.mat'],'yr','totcatch',...
...
title('Mean D catch')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_log10catch_comp_types_temp_NoElasmo.png'])
...
title('Mean catch (no elasmo) without Polar and Australia')
...
title('Mean D catch')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_log10catch_comp_types_LELC_temp_NoElasmo.png'])
...
title('C. Demersals')
% stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_log10catch_comp_types_LELC_temp_ms_NoElasmo.png'])
