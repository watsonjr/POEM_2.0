...
load([spath 'SAUP_LME_Catch_annual_no_elasmo_bathy.mat'],'yr','totcatch','lme_catch',...
...
Fstat = array2table(fish_stat,'VariableNames',{'r','RMSE','Fmed'},...
    'RowNames',{'All','F','P','D'});
writetable(Fstat,[dpath 'LME_SAUP_noElasmoBathy_stats_' cfile '.csv'],'Delimiter',',')
...
title('Mean D catch')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_types_temp_Stock_LELC_noElasmoBathy.png'])
...
title('C. Demersals')
% stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_types_temp_Stock_LELC_noElasmoBathy_ms.png'])
