...
Flme_catch_all = nansum(Flme_catch,3);
Plme_catch_all = nansum(Plme_catch,3);
Dlme_catch_all = nansum(Dlme_catch,3);
...
% %plot(l10s,ylog,'r'); hold on;
% axis([0 8 0 8])
% xlabel('SAUP F catch (MT) mean of top 10 years')
% ylabel('POEM F catch (MT) mean of Historic 1956-2005')
% title('Mean F catch')
% print('-dpng',[ppath 'Historic_fished',harv,'_SAUP_log10catch_compF.png'])
% 
% figure(3)
% plot(x,x,'--k'); hold on;
...
% %plot(l10s,ylog,'r'); hold on;
% axis([0 8 0 8])
% xlabel('SAUP P catch (MT) mean of top 10 years')
% ylabel('POEM P catch (MT) mean of Historic 1956-2005')
% title('Mean P catch')
% print('-dpng',[ppath 'Historic_fished',harv,'_SAUP_log10catch_compP.png'])
% 
% figure(4)
% plot(x,x,'--k'); hold on;
...
% %plot(l10s,ylog,'r'); hold on;
% axis([0 8 0 8])
% xlabel('SAUP D catch (MT) mean of top 10 years')
% ylabel('POEM D catch (MT) mean of Historic 1956-2005')
% title('Mean D catch')
% print('-dpng',[ppath 'Historic_fished',harv,'_SAUP_log10catch_compD.png'])
...
title('Mean D catch')
print('-dpng',[ppath 'Historic_fished',harv,'_SAUP_log10catch_comp_types.png'])
...
title('F NW Atl 1956-2005 mean catch')
for i=1:length(nwa)
...
xlabel('log10 SAUP catch (MT) top 10 yrs')
ylabel('log10 POEM catch (MT)')
title('P NW Atl 1956-2005 mean catch')
for i=1:length(nwa)
...
xlabel('log10 SAUP catch (MT) top 10 yrs')
ylabel('log10 POEM catch (MT)')
title('D NW Atl 1956-2005 mean catch')
for i=1:length(nwa)
...
xlabel('log10 SAUP catch (MT) top 10 yrs')
ylabel('log10 POEM catch (MT)')
title('F Africa 1956-2005 mean catch')
for i=1:length(afr)
...
xlabel('log10 SAUP catch (MT) top 10 yrs')
ylabel('log10 POEM catch (MT)')
title('P Africa 1956-2005 mean catch')
for i=1:length(afr)
...
xlabel('log10 SAUP catch (MT) top 10 yrs')
ylabel('log10 POEM catch (MT)')
title('D Africa 1956-2005 mean catch')
for i=1:length(afr)
...
[rall,pall]=corrcoef(l10s(keep),l10p(keep))
[rF,pF]=corrcoef(l10sF(keep),l10pF(keep))
[rP,pP]=corrcoef(l10sP(keep),l10pP(keep))
[rD,pD]=corrcoef(l10sD(keep),l10pD(keep))
...
text(3.5,7.5,['r = ' num2str(rall(2,1))])
axis([3 8 3 8])
xlabel('SAUP catch (MT) mean of top 10 years')
ylabel('Total mean of Historic 1956-2005')
...
text(3.5,7.5,['r = ' num2str(rD(2,1))])
axis([3 8 3 8])
xlabel('SAUP D catch (MT)')
ylabel('POEM D catch (MT)')
title('Mean D catch')
print('-dpng',[ppath 'Historic_fished',harv,'_SAUP_log10catch_comp_types_LELC.png'])
...
ylim(hcb,[-50 50])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Historic 1956-2005 difference from SAUP total annual F catch (MT)')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_LME_SAUP_catch_diffF.png'])
...
ylim(hcb,[-50 50])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Historic 1956-2005 difference from SAUP total annual P catch (MT)')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_LME_SAUP_catch_diffP.png'])
...
ylim(hcb,[-50 50])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Historic 1956-2005 difference from SAUP total annual D catch (MT)')
stamp(cfile)
print('-dpng',[ppath 'Hist_fished_LME_SAUP_catch_diffD.png'])
