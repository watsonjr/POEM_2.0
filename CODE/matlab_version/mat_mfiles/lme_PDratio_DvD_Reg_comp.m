...
diffL = dlme_Pfrac - lFracPD_grid;
diffC = dlme_Pfrac - cFracPD_grid;
...
writetable(Fstat,[spath 'LME_DvD_vs_Reg_stats.csv'],'Delimiter',',','WriteRowNames',true)
save([spath 'LME_DvD_vs_Reg_stats.mat'],'fish_stat')
...
stamp('')
print('-dpng',[spath 'LME_DvD_vs_Reg_landings_comp_fracP.png'])
...
title('Fraction Large Pelagics')
stamp('')
print('-dpng',[spath 'LME_DvD_vs_Reg_catch_comp_fracP.png'])
...
title('Fraction Large Pelagics')
stamp('')
print('-dpng',[spath 'LME_fracPD_DvD_vs_Reg_landings_comp_subplot.png'])
...
title('Fraction Large Pelagics')
stamp('')
print('-dpng',[spath 'LME_fracPD_DvD_vs_Reg_catch_comp_subplot.png'])
