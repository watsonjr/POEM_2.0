...
writetable(Fstat,[dpath 'LME_DvD_SAU_stats_noTunas_' cfile '.csv'],'Delimiter',',','WriteRowNames',true)
save([dpath 'LME_DvD_SAU_stats_noTunas_' cfile '.mat'],'fish_stat')
...
%title('Fraction Large Pelagics')
%stamp(cfile)
print('-dpng',[ppath 'Clim_' harv '_LME_fracPD_catch_SAUP_DvD_comp_subplot_noTunas.png'])
