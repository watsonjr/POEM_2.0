...
SF = NaN*ones(length(bmp),length(ktemp),16);
SP = SF;
SD = SF;
MF = SF;
MP = SF;
...
%         tbe = num2str(100+int64(100*bent_eff));
    ...
    sfile = ['/Volumes/GFDL/NC/Matlab_new_size/',cfile,...
        '/param_sens/Climatol_All_fish03_m-b',tbfn(2:end),'-k',tkfn(2:end),'_locs.mat'];
    load(sfile);
...
save([nfile 'Locs_Climatol_All_fish03_means_bm_kt_search.mat'],'SF','SP','SD',...
