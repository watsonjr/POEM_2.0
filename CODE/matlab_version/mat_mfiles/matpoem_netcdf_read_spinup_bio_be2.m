...
sb_tmean=mean(SB.bio,1);
mb_tmean=mean(MB.bio,1);
...
sb_mean=mean(SB.bio(:,lyr),2);
mb_mean=mean(MB.bio(:,lyr),2);


%
save([fpath 'Means_spinup_' cfile '.mat'],...
    'sf_mean','sp_mean','sd_mean','mf_mean','mp_mean','md_mean','sb_mean',...
    'mb_mean','lp_mean','ld_mean','sf_tmean','sp_tmean','sd_tmean','mf_tmean','mp_tmean',...
    'md_tmean','sb_tmean','mb_tmean','lp_tmean','ld_tmean','time','lyr');
