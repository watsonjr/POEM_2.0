...
%% SF
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_sml_f.nc'],'NC_NOWRITE');
...
%% SP
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_sml_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% SD
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_sml_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MP
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_med_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%% MF
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_med_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MD
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_med_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LP
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_lrg_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LD
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_lrg_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% Benthic material
ncid = netcdf.open([fpath 'Climatol_' harv '_ICbiom1000_bent.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
sp_ts_locs=SP.bio(ID,:);
sf_ts_locs=SF.bio(ID,:);
sd_ts_locs=SD.bio(ID,:);
mp_ts_locs=MP.bio(ID,:);
mf_ts_locs=MF.bio(ID,:);
md_ts_locs=MD.bio(ID,:);
lp_ts_locs=LP.bio(ID,:);
ld_ts_locs=LD.bio(ID,:);
b_ts_locs=BENT.bio(ID,:);
...
%%
save([fpath 'Means_Climatol_' harv '_ICbiom1000_' cfile '.mat'],'time','lyr',...
    ...
    'sf_ts_locs','sp_ts_locs','sd_ts_locs',...
    'mf_ts_locs','mp_ts_locs','md_ts_locs',...
    'lp_ts_locs','ld_ts_locs','b_ts_locs');
