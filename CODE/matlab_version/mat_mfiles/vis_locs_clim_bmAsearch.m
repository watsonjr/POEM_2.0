...
load([nfile 'Locs_Climatol_All_fish03_means_bmAsearch.mat']);
pname = 'Climatol_All_fish03_means_bmAsearch';
...
allF2 = NaN*ones(11,7,16);
allP2 = NaN*ones(11,7,16);
allD2 = NaN*ones(11,7,16);
FP2 = NaN*ones(11,7,16);
DP2 = NaN*ones(11,7,16);
