...
RE = {'01000','00500','00250','00100','00075'};%,'00050'};
reff = [0.1,0.05,0.025,0.01,0.0075];%,0.005];
sreff = {'0.1','0.05','0.025','0.01','0.0075'};%,'0.005'};
...
for R = 1:length(RE)
    rfrac = RE{R};
    tre2 = num2str(100000+int64(round(10000*reff2(R))));
    rfrac2 = tre2(2:end);
...
for s=1:length(spots)
    ...
    if (s==11)
        ...
        text(np+2,-1.5,['mdRE=' num2str(mult) 'x lgRE']);
    end
    stamp(cfile2)
