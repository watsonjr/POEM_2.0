...
for E = 1:length(bees)
    ...
    close all
    dp = ['Dc_enc70-b',tbfn(2:end),'_cm20_m-b',num2str(metb),...
        '-k09_fcrit20_D075_J100_A050_Sm025_nmort1_BE05_CC100_lgRE00100_mdRE00100'];
    dpath = [datap char(dp) '/'];
    fpath = [figp char(dp) '/'];
...
for n = 1:length(bees)
    ...
    fpath = [figp char(dp) '/'];
    cfile = char(dp);
    cfile2 = ['Dc_enc70_cm20_m-b',num2str(metb),...
        '-k09_fcrit20_D075_J100_A050_Sm025_nmort1_BE05_CC100_lgRE00100_mdRE00100_encBtests'];
