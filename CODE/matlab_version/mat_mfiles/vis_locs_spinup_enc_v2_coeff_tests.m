...
for C = 1:length(cof)
    cff = cof(C);
    dp = ['Dc_enc',tefn,'_q',num2str(cff),'_cmax-metab',tcfn,'_fcrit',num2str(fcrit),'_',...
            D,'_',J,'_',Ad,'_',Sm,...
...
for n = 1:length(cof)
    ...
    fpath = [figp char(dp) '/'];
    cfile = char(dp);
    cfile2 = ['Dc_enc',tefn,'_cmax-metab',tcfn,'_fcrit','_',...
            D,'_',J,'_',Ad,'_',Sm,'_nmort',nmort,'_BE',BE,'_CC',CC,...
            '_lgRE',rfrac,'_mdRE',rfrac2,'_EncCoefftests'];
