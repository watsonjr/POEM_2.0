...
for E = 1:length(bees)
    ...
    close all
    dp = ['Dc_enc70_cm20_m-b',tbfn(2:end),'_c-b',num2str(cmaxb),...
        '_m-k09_fcrit20_D075_J100_A050_Sm025_nmort1_BE05_CC100_lgRE00100_mdRE00100'];
    dpath = [datap char(dp) '/'];
    fpath = [figp char(dp) '/'];
    ...
    load([dpath sname 'locs_All_fish03.mat'])
    SP = S_Sml_p;
    SF = S_Sml_f;
    SD = S_Sml_d;
    MP = S_Med_p;
...
for n = 1:length(bees)
    ...
    fpath = [figp char(dp) '/'];
    cfile = char(dp);
    cfile2 = ['Dc_enc70_cm20_c-b',num2str(cmaxb),'_m-k09_fcrit20_D075_J100_A050_Sm025_nmort1_BE05_CC100_lgRE00100_mdRE00100_metBtests'];
