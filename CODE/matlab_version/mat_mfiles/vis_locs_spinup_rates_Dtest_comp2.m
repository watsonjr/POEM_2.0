...
dp6 = 'Dc_enc70_cmax-metab20_fcrit20_D080_J100_A050_Sm025_nmort1_BE05_CC050_lgRE00100_mdRE00400';
dpath1 = [datap char(dp1) '/'];
fpath = figp;
dpath6 = [datap char(dp6) '/'];
cfile = 'Dc_enc70_cmax-metab20_fcrit20_J100_A050_Sm025_nmort1_BE05_CC050_lgRE00100_mdRE00400_Dtest';
...
title('All F stages')
stamp(cfile)
print('-dpng',[fpath cfile '_All_oneloc_tot_mean_Fbiomass_D075_D080.png'])
...
title('All P stages')
stamp(cfile)
print('-dpng',[fpath cfile '_All_oneloc_tot_mean_Dbiomass_D075_D080.png'])
...
%%
figure(4);
plot(1:11,log10(sumspec1),'o','Color',cmap_ppt(3,:),'MarkerSize',10); hold on;
plot(1.1:11.1,log10(sumspec6),'o','Color',cmap_ppt(1,:),'MarkerSize',10); hold on;
legend('D=0.75','D=0.80')
xlim([0 12])
ylim([-2 2])
set(gca,'XTick',1:11,'XTickLabel',[])
...
stamp(cfile)
print('-dpng',[fpath 'All_oneloc_tot_mean_biomass_spec_D075_D080.png'])
