...
stamp(cfile)
print('-dpng',[ppath 'Climatol_' harv '_global_loop_All_subplot.png'])
...
set(gcf,'renderer','painters')
title('A. Large Pelagics vs. Forage Fishes')
...
caxis([0 1]);
set(gcf,'renderer','painters')
title('B. Large Pelagics vs. Demersals')
stamp(cfile)
print('-dpng',[ppath 'Climatol_' harv '_global_loop_ratios_subplot_v2.png'])
