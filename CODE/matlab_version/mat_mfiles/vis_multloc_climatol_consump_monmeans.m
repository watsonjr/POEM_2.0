...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SP_con.png'])
%
% % sf
% figure(12)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SF_con.png'])
%
% % sd
% figure(13)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SD_con.png'])
%
% % mp
% figure(14)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MP_con.png'])
%
% % mf
% figure(15)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MF_con.png'])
%
% % md
% figure(16)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MD_con.png'])
%
% % lp
% figure(17)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_LP_con.png'])
%
% % ld
% figure(18)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_LD_con.png'])
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_All_con.png'])
% 
% % all F
% figure(22)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllF_con.png'])
% 
% % all D
% figure(23)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllD_con.png'])
% 
% % All P
% figure(24)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllP_con.png'])
...
stamp([harv '_' cfile])
print('-dpng',[ppath 'Climatol_' harv '_global_All_subplot_con.png'])
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllS_con.png'])
% 
% % all M
% figure(3)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllM_con.png'])
% 
% % All L
% figure(4)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllL_con.png'])
...
title(' mean All fishes')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Climatol_' harv '_global_sizes_subplot_con.png'])
