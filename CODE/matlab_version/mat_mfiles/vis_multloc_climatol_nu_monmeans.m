...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SP_nu.png'])
%
% % sf
% figure(12)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SF_nu.png'])
%
% % sd
% figure(13)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_SD_nu.png'])
%
% % mp
% figure(14)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MP_nu.png'])
%
% % mf
% figure(15)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MF_nu.png'])
%
% % md
% figure(16)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_MD_nu.png'])
%
% % lp
% figure(17)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_LP_nu.png'])
%
% % ld
% figure(18)
...
% caxis([-2 1])
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_LD_nu.png'])
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_All_nu.png'])
% 
% % all F
% figure(22)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllF_nu.png'])
% 
% % all D
% figure(23)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllD_nu.png'])
% 
% % All P
% figure(24)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllP_nu.png'])
...
stamp([harv '_' cfile])
print('-dpng',[ppath 'Climatol_' harv '_global_All_subplot_nu.png'])
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllS_nu.png'])
% 
% % all M
% figure(3)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllM_nu.png'])
% 
% % All L
% figure(4)
% axesm ('Robinson','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','on',...
...
% stamp([harv '_' cfile])
% print('-dpng',[ppath 'Climatol_' harv '_global_AllL_nu.png'])
...
stamp([harv '_' cfile])
print('-dpng',[ppath 'Climatol_' harv '_global_sizes_subplot_nu.png'])
