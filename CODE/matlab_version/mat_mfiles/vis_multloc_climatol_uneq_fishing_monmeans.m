...
%         tharv = ['Harvest all fish ' num2str(frate)];
        ...
        cfile = 'Dc_enc70_cmax-metab20_b18_k09_fcrit20_D075_J100_A075_Sm025_nmort1_BE05_CC050_lgRE00100_mdRE00100';
        harv = ['fish_F01_P03_D06'];
        tharv = 'Harvest F0.1 P0.3 D0.6';
