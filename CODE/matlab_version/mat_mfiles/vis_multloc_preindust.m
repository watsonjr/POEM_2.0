...
% set(gcf,'renderer','painters')
% title('Preindustrial log10 mean Benthic inverts (mg m^-^2)')
% stamp(cfile)
...
set(gcf,'renderer','painters')
title('Preindustrial log10 mean All fishes (g m^-^2)')
stamp(cfile)
...
set(gcf,'renderer','painters')
title('Preindustrial log10 mean All F (g m^-^2)')
stamp(cfile)
...
ylim(hcb,[-1 1])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Preindustrial log10 mean All D (g m^-^2)')
stamp(cfile)
...
ylim(hcb,[-1 1])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Preindustrial log10 mean All P (g m^-^2)')
stamp(cfile)
...
stamp(cfile)
print('-dpng',[ppath 'Preindust_global_All_subplot.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Preindust_global_ratios_subplot.png'])
