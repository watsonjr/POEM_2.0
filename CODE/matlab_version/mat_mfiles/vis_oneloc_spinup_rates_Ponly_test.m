...
for r = 1:length(RE)
    ...
    %%
    f20=figure(20);
    plot(log10(SP(:,1)),'r','LineWidth',2);hold on;
    plot(log10(MP(:,1)),'b','LineWidth',2);hold on;
    plot(log10(LP(:,1)),'k','LineWidth',2);hold on;
    legend('S','M','L')
    title(['RE=' rfrac ' ' loc])
    print(f20,'-dpng',[fpath sname loc '_P_time.png'])
