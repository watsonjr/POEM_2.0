...
# load data
vec <- read.csv("Climatol_All_fish03_param_sens_v2_vecs.csv",sep=",",header = T)
...
## ----------------------------------- dendextend -------------------------------------------
library(dendextend)
pdf(paste0(fpath,"Climatol_All_fish03_param_sens_pairplot.pdf"))
...
# And plot:
pdf(paste0(fpath,"Climatol_All_fish03_hclust_complete.pdf"))
par(mfrow = c(1,1))
par(mar = c(3,3,3,7))
plot(dend, 
...
library(gplots)
pdf(paste0(fpath,"Climatol_All_fish03_hclust_complete_heatmap_v1.pdf"))
...
pdf(paste0(fpath,"Climatol_All_fish03_hclust_complete_heatmap_v2.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_corr_diff_methods.pdf"))
...
pdf(paste0(fpath,"Climatol_All_fish03_diff_methods.pdf"))
par(mfrow = c(4,2))
for(i in 1:8) {
