...
# And plot:
pdf(paste0(fpath,"Climatol_All_fish03_hclust_complete_untrans.pdf"))
par(mfrow = c(1,1))
par(mar = c(3,3,3,7))
plot(dend, 
...
pdf(paste0(fpath,"Climatol_All_fish03_hclust_complete_heatmap_untrans.pdf"))
...
pdf(paste0(fpath,"Climatol_All_fish03_corr_diff_methods_untrans.pdf"))
...
pdf(paste0(fpath,"Climatol_All_fish03_diff_methods_untrans.pdf"))
par(mfrow = c(4,2))
for(i in 1:8) {
...
## -------------- Diff methods -------------------------------
pdf(paste0(fpath,"Climatol_All_fish03_hclust_wardD_heatmap_untrans.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_hclust_single_heatmap_untrans.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_hclust_average_heatmap_untrans.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_hclust_mcquitty_heatmap_untrans.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_hclust_median_heatmap_untrans.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_hclust_centroid_heatmap_untrans.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_hclust_wardD2_heatmap_untrans.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
