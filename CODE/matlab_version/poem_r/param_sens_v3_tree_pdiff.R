...
# load data
vec <- read.csv("Climatol_All_fish03_param_sens_v3_vecs_pdiff.csv",sep=",",header = T)
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_pvclust_wardD_pvals_pdiff.pdf"))
...
fit3 <- pvclust(rvec, method.hclust="complete",
                method.dist="euclidean")
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_pvclust_complete_pvals_pdiff.pdf"))
...
## ----------------------------------- dendextend -------------------------------------------
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_param_sens_pairplot_pdiff.pdf"))
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_hclust_complete_heatmap_pdiff.pdf"))
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_corr_diff_methods_pdiff.pdf"))
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_diff_methods_pdiff.pdf"))
par(mfrow = c(4,2))
for(i in 1:8) {
...
## -------------- Diff methods -------------------------------
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_hclust_wardD_heatmap_pdiff.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_hclust_single_heatmap_pdiff.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_hclust_average_heatmap_pdiff.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_hclust_mcquitty_heatmap_pdiff.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_hclust_median_heatmap_pdiff.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_hclust_centroid_heatmap_pdiff.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
...
pdf(paste0(fpath,"Climatol_All_fish03_sensv3_hclust_wardD2_heatmap_pdiff.pdf"))
gplots::heatmap.2(as.matrix(t(nvec)), 
