function sub_init()
sub_init_env(ID, ENV);
sub_init_fish(ID,phen,Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT);

%============== INITIAL CONDITIONS =============%
    function sub_init_env(ID, ENV)
        ...
        ENV.U   = NaN*ones(NX,1);
        ENV.V   = NaN*ones(NX,1);
        ENV.T0p = NaN*ones(NX,1);
        ENV.T0b = NaN*ones(NX,1);
        ENV.Dthresh = NaN*ones(NX,1);
    ...
    function sub_init_fish(ID,phen,Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT)
