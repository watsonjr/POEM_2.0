...
function sub_futbio!(ID,DY,COBALT,ENVR,Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT,dfrate,rfrac)
	...
	for JD = 1:NX
		...
		Sml_f.enc_zm[JD] = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_s,Sml_f.bio[JD],ENVR.Zm[JD],Sml_f.td[JD],Sml_f.td[JD],1)
		Sml_p.enc_zm[JD] = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_s,Sml_p.bio[JD],ENVR.Zm[JD],Sml_p.td[JD],Sml_f.td[JD],1)
		Sml_d.enc_zm[JD] = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_s,Sml_d.bio[JD],ENVR.Zm[JD],Sml_d.td[JD],Sml_f.td[JD],1)

		Med_f.enc_zm[JD] = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_f.bio[JD],ENVR.Zm[JD],Med_f.td[JD],Med_f.td[JD],MF_phi_MZ)
		Med_f.enc_zl[JD] = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_f.bio[JD],ENVR.Zl[JD],Med_f.td[JD],Med_f.td[JD],MF_phi_LZ)
		Med_f.enc_f[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_f.bio[JD],Sml_f.bio[JD],Med_f.td[JD],Med_f.td[JD],MF_phi_S)
		Med_f.enc_p[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_f.bio[JD],Sml_p.bio[JD],Med_f.td[JD],Med_f.td[JD],MF_phi_S)
		Med_f.enc_d[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_f.bio[JD],Sml_d.bio[JD],Med_f.td[JD],Med_f.td[JD],MF_phi_S)

		Med_p.enc_zm[JD] = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_p.bio[JD],ENVR.Zm[JD],Med_p.td[JD],Med_p.td[JD],MP_phi_MZ)
		Med_p.enc_zl[JD] = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_p.bio[JD],ENVR.Zl[JD],Med_p.td[JD],Med_p.td[JD],MP_phi_LZ)
		Med_p.enc_f[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_p.bio[JD],Sml_f.bio[JD],Med_p.td[JD],Med_p.td[JD],MP_phi_S)
		Med_p.enc_p[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_p.bio[JD],Sml_p.bio[JD],Med_p.td[JD],Med_p.td[JD],MP_phi_S)
		Med_p.enc_d[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_p.bio[JD],Sml_d.bio[JD],Med_p.td[JD],Med_p.td[JD],MP_phi_S)

		Med_d.enc_be[JD] = sub_enc_dem(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_d.bio[JD],BENT.mass[JD],Med_d.td[JD],1-Med_d.td[JD],MD_phi_BE)

		Lrg_p.enc_f[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_l,Lrg_p.bio[JD],Med_f.bio[JD],Lrg_p.td[JD],Lrg_p.td[JD],LP_phi_MF)
		Lrg_p.enc_p[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_l,Lrg_p.bio[JD],Med_p.bio[JD],Lrg_p.td[JD],Lrg_p.td[JD],LP_phi_MP)
		Lrg_p.enc_d[JD]  = sub_enc_pel(ENVR.Tp[JD],ENVR.Tb[JD],M_l,Lrg_p.bio[JD],Med_d.bio[JD],Lrg_p.td[JD],1-Lrg_p.td[JD],LP_phi_MD)

		Lrg_d.enc_f[JD]  = sub_enc_dem(ENVR.Tp[JD],ENVR.Tb[JD],M_l,Lrg_d.bio[JD],Med_f.bio[JD],Lrg_d.td[JD],Lrg_d.td[JD],LD_phi_MF)
		Lrg_d.enc_p[JD]  = sub_enc_dem(ENVR.Tp[JD],ENVR.Tb[JD],M_l,Lrg_d.bio[JD],Med_p.bio[JD],Lrg_d.td[JD],Lrg_d.td[JD],LD_phi_MP)
		Lrg_d.enc_d[JD]  = sub_enc_dem(ENVR.Tp[JD],ENVR.Tb[JD],M_l,Lrg_d.bio[JD],Med_d.bio[JD],Lrg_d.td[JD],1-Lrg_d.td[JD],LD_phi_MD)
		Lrg_d.enc_be[JD] = sub_enc_dem(ENVR.Tp[JD],ENVR.Tb[JD],M_l,Lrg_d.bio[JD],BENT.mass[JD],Lrg_d.td[JD],1-Lrg_d.td[JD],LD_phi_BE)
