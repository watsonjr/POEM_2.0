...
function sub_futbio!(ID,DY,COBALT,ENVR,Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT,dfrate,rfrac,CC,bent_eff)
	...
	for JD = 1:NX
		...
		#! Fishing by rate
		Med_f.bio[JD], Med_f.caught[JD] = sub_fishing_rate(Med_f.bio[JD],dfrate,MFsel)
		#Med_p.bio[JD], Med_p.caught[JD] = sub_fishing_rate(Med_p.bio[JD],dfrate)
		#Med_d.bio[JD], Med_d.caught[JD] = sub_fishing_rate(Med_d.bio[JD],dfrate)
		Lrg_p.bio[JD], Lrg_p.caught[JD] = sub_fishing_rate(Lrg_p.bio[JD],dfrate,LPsel)
		Lrg_d.bio[JD], Lrg_d.caught[JD] = sub_fishing_rate(Lrg_d.bio[JD],dfrate,LDsel)
