...
function sub_futbio!(ID,DY,COBALT,ENVR,Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT)
	...
	for JD = 1:NX
	  ...
	  Lrg_d.td[JD] = sub_tdif_dem(ENVR.H[JD],Med_f.bio[JD],Med_p.bio[JD],Med_d.bio[JD],BENT.mass[JD])
		...
		Med_f.enc_f[JD]  = sub_encF(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_f.bio[JD],Sml_f.bio[JD],Med_f.td[JD],1,0.5)
		...
		Med_p.enc_p[JD]  = sub_encP(ENVR.Tp[JD],ENVR.Tb[JD],M_m,Med_p.bio[JD],Sml_p.bio[JD],Med_p.td[JD],1,0.5)
